...
export const App = () => {
  ...
  return (
    <div ref={container}>
      ...
      { (mode === "runtime" || report) && authoredState && <Runtime authoredState={authoredState} interactiveState={interactiveState} setInteractiveState={setInteractiveState} report={report} setNavigation={setNavigation} /> }
