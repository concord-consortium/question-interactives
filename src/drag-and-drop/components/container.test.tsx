...
const authoredState = {
  ...
  draggableItems: [
    {id: "1", imageUrl: "http://image/1", itemLabel: "image label 1", index: 1, itemValue: 5, itemUnit: "oz"},
    {id: "2", imageUrl: "http://image/2", itemLabel: "image label 2", index: 2, itemValue: 2, itemUnit: "oz"},
  ]
};
