...
export const reportItemHandler: IGetReportItemAnswerHandler<IInteractiveState, IAuthoredState> = request => {
  ...
  if (!version) {
    ...
    console.error("Starter Report Item Interactive: Missing version in getReportItemAnswer request.");
  }
    ...
    // tslint:disable-next-line:no-console
    console.error(
      "Starter Report Item Interactive: Unsupported version in getReportItemAnswer request:",
      version
    );
  }
};
