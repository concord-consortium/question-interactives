...
describe("Widgets", () => {
  ...
  describe("null sim handling", () => {
    it("returns null when sim is null", () => {
      const { container } = render(<Widgets sim={null} isRecording={false} inRecordingMode={false} isCompletedRecording={false} />);
  ...
  describe("basic rendering", () => {
    it("renders widgets container when sim has widgets", () => {
      ...
      render(<Widgets sim={mockSim as AgentSimulation} isRecording={false} inRecordingMode={false} isCompletedRecording={false} />);
  ...
  describe("CSS classes", () => {
    it("applies correct size class for short widgets", () => {
      ...
      const { container } = render(<Widgets sim={mockSim as AgentSimulation} isRecording={false} inRecordingMode={false} isCompletedRecording={false} />);
  ...
  describe("widget component rendering", () => {
    it("renders widget component with correct props", () => {
      ...
      render(<Widgets sim={mockSim as AgentSimulation} isRecording={true} inRecordingMode={true} isCompletedRecording={false} />);
